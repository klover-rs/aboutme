...
export function applyCssTheme(jsonTheme: Style) {
    ...
    document.documentElement.style.setProperty('--background-color-primary', jsonTheme.background_color_primary);
    document.documentElement.style.setProperty('--background-color-secondary', jsonTheme.background_color_secondary);
    document.documentElement.style.setProperty('--primary-grey', jsonTheme.primary_grey);
    document.documentElement.style.setProperty('--secondary-grey', jsonTheme.secondary_grey);
    document.documentElement.style.setProperty('--font-size', jsonTheme.font_size);
    ...
    if (jsonTheme.transparency === false) {
        ...
        document.documentElement.style.setProperty('--transparency', String(jsonTheme.transparency_value));
        document.documentElement.style.setProperty('--transparency-blur', jsonTheme.transparency_blur);
    }
}
    ...
    useEffect(() => {
        ...
        if (getTheme) {
          ...
          console.log("theme loaded");
            ...
            const newTheme: Style = JSON.parse(localStorage.getItem(storageKey) ?? '{}'); 
